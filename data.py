...
st.sidebar.markdown("2023年NHKマイルカップ　データ")
sample2=pd.read_csv("NHK Mile Cup 2023.csv")
sample2=sample2.to_csv(index=False)  
b64 = base64.b64encode(sample2.encode('utf-8-sig')).decode()
href = f'<a href="data:application/octet-stream;base64,{b64}" download="NHK Mile Cup 2023.csv">NHK Mile Cup 2023</a>'
st.sidebar.markdown(f"{href}", unsafe_allow_html=True)
