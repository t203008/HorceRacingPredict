...
if a=="全レース":
  ...
  y=st.selectbox("レース選択",("中山金杯","京都金杯","フェアリーステークス","シンザン記念","愛知杯","日経新春杯","京成杯","アメリカジョッキークラブカップ","東海ステークス","根岸ステークス","シルクロードステークス","東京新聞杯","きさらぎ賞","クイーンカップ","共同通信杯","京都記念","京都牝馬ステークス","ダイヤモンドステークス","小倉大賞典","フェブラリーステークス","阪急杯","中山記念","チューリップ賞","オーシャンステークス","弥生賞","フラワーカップ","ファルコンステークス","阪神大賞典","スプリングステークス","日経賞","毎日杯","マーチステークス","高松宮記念","ダービー卿チャレンジトロフィー","大阪杯","桜花賞","皐月賞","天皇賞（春）","NHKマイルカップ","ヴィクトリアマイル","優駿牝馬（オークス）","東京優駿（日本ダービー）","安田記念","宝塚記念","スプリンターズステークス","秋華賞","天皇賞（秋）","エリザベス女王杯","マイルチャンピオンシップ","ジャパンカップ","チャンピオンズカップ","中日新聞杯","カペラステークス","阪神ジュベナイルフィリーズ","ターコイズステークス","朝日杯フューチュリティステークス","阪神カップ","有馬記念","ホープフルステークス"))
  if y=="エリザベス女王杯":
    b="Queen Elizabeth II Cup"
  elif y=="阪神大賞典":
    b="Hanshin Daishoten"
  elif y=="ダービー卿チャレンジトロフィー":
    b="Lord Derby Challenge Trophy"
  elif y=="日経賞":
    b="Nikkei Sho"
  elif y=="毎日杯":
    b="Mainichi Hai"
    ...
    b="Silk Road Stakes"
  elif y=="アメリカジョッキークラブカップ":
    b="American Jockey Club Cup"
  elif y=="東海ステークス":
    b="Tokai Stakes"
  elif y=="愛知杯":
    b="Aichi Hai"
  elif y=="日経新春杯":
    b="Nikkei Shinshun Hai"
  elif y=="京成杯":
    b="Keisei Hai"
  elif y=="中山金杯":
    b="Nakayama Kimpai"
...
if pred is not None:
  ...
  if waku=="入れる":
    ...
    logistic1 = smf.glm(formula = "Win ~ 1+Age+Frame_one+Frame_two+Frame_three+Frame_four+Frame_five+Frame_six+Frame_seven+Frame_eight+P_rank+P_popular+P_restrict+P_marelimit+Jockey_change+Change_from_P_Grass+Change_from_P_Dirt+Change_from_P_Hurdle+P_class_Class+Weight_P_Weight+Distance_P_distance+Week_distance+P_overseas+P_rank*P_popular*P_class_Class",
                   data = Z ,
                   family = sm.families.Binomial()).fit()
    logistic2 = smf.glm(formula = "Quinella ~ 1+Age+Frame_one+Frame_two+Frame_three+Frame_four+Frame_five+Frame_six+Frame_seven+Frame_eight+P_rank+P_popular+P_restrict+P_marelimit+Jockey_change+Change_from_P_Grass+Change_from_P_Dirt+Change_from_P_Hurdle+P_class_Class+Weight_P_Weight+Distance_P_distance+Week_distance+P_overseas+P_rank*P_popular*P_class_Class",
                   data = Z ,
                   family = sm.families.Binomial()).fit()
    logistic3 = smf.glm(formula = "Show ~ 1+Age+Frame_one+Frame_two+Frame_three+Frame_four+Frame_five+Frame_six+Frame_seven+Frame_eight+P_rank+P_popular+P_restrict+P_marelimit+Jockey_change+Change_from_P_Grass+Change_from_P_Dirt+Change_from_P_Hurdle+P_class_Class+Weight_P_Weight+Distance_P_distance+Week_distance+P_overseas+P_rank*P_popular*P_class_Class",
                   data = Z ,
                   family = sm.families.Binomial()).fit()
  elif waku=="入れない":
    ...
    logistic1 = smf.glm(formula = "Win ~ 1+Age+P_rank+P_popular*P_popular+P_popular+Jockey_change+Change_from_P_Grass+Change_from_P_Dirt+Change_from_P_Hurdle+P_class_Class+Weight_P_Weight+Distance_P_distance+Week_distance+P_overseas",#+P_restrict+P_marelimit",
                   data = Z ,
                   family = sm.families.Binomial()).fit()
    logistic2 = smf.glm(formula = "Quinella ~ 1+Age+P_rank+P_popular*P_popular+P_popular+Jockey_change+Change_from_P_Grass+Change_from_P_Dirt+Change_from_P_Hurdle+P_class_Class+Weight_P_Weight+Distance_P_distance+Week_distance+P_overseas+P_restrict+P_marelimit",
                   data = Z ,
                   family = sm.families.Binomial()).fit()
    logistic3 = smf.glm(formula = "Show ~ 1+Age+P_rank+P_popular*P_popular+P_popular+Jockey_change+Change_from_P_Grass+Change_from_P_Dirt+Change_from_P_Hurdle+P_class_Class+Weight_P_Weight+Distance_P_distance+Week_distance+P_overseas+P_restrict+P_marelimit",
                   data=Z,
                   family = sm.families.Binomial()).fit() 
