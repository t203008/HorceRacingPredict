...
sample2=pd.read_csv("Oka Sho (Japanese 1000 Guineas) 2023.csv")
sample2=sample2.to_csv(index=False)  
b64 = base64.b64encode(sample2.encode('utf-8-sig')).decode()
href = f'<a href="data:application/octet-stream;base64,{b64}" download="Oka Sho (Japanese 1000 Guineas) 2023.csv">Oka Sho (Japanese 1000 Guineas) 2023</a>'
st.sidebar.markdown(f"{href}", unsafe_allow_html=True)
